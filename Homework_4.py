...
origin_list = [1, 2, 4, 0]
mod_list = [el ** 2 for el in origin_list]

print(mod_list)

#2

first_list = ["яблоко", "банан", "персик"]
second_list = ["яблоко", "груша", "банан", "абрикос"]
third_list = [el for el in first_list if el in second_list]
